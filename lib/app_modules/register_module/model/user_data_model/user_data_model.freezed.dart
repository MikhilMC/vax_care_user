...
mixin _$UserDataModel {
  ...
  int? get noOfChildren => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      relationship: freezed == relationship
          ...
          : relationship // ignore: cast_nullable_to_non_nullable
              as String?,
      noOfChildren: freezed == noOfChildren
          ? _value.noOfChildren
          : noOfChildren // ignore: cast_nullable_to_non_nullable
              as int?,
    ) as $Val);
  }
}
...
class _$UserDataModelImpl implements _UserDataModel {
  ...
  @override
  String toString() {
    return 'UserDataModel(id: $id, image: $image, name: $name, email: $email, phone: $phone, password: $password, address: $address, relationship: $relationship, noOfChildren: $noOfChildren)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.noOfChildren, noOfChildren) ||
                other.noOfChildren == noOfChildren));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, image, name, email, phone,
      password, address, relationship, noOfChildren);
...
abstract class _UserDataModel implements UserDataModel {
  const factory _UserDataModel(
      ...
      final String? address,
      final String? relationship,
      final int? noOfChildren}) = _$UserDataModelImpl;
